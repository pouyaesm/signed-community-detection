...
public class SparseMatrix extends AbstractMatrix {
    ...
    /**
     * Return sparse matrix of only positive (or negative) values
     * @param isPositive
     * @return
     */
    public SparseMatrix getUniSignMatrix(boolean isPositive){
        return newInstance().init(getListMatrix().getUniSignListMatrix(isPositive));
    }
    /**
     * Get full matrix
     * @return
